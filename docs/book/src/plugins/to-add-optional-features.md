...
| [helm.kubebuilder.io/v1-alpha][helm-v1alpha] (deprecated) | `helm/v1-alpha`         | **Deprecated** - Optional helper plugin which can be used to scaffold a Helm Chart to distribute the project under the `dist` directory. Use v3-alpha instead.                     |
| [helm.kubebuilder.io/v2-alpha][helm-v2alpha] (deprecated) | `helm/v2-alpha`         | **Deprecated** - Optional helper plugin which dynamically generates Helm charts from kustomize output, preserving all customizations                                                                     |
| [helm.kubebuilder.io/v3-alpha][helm-v3alpha] (deprecated) | `helm/v3-alpha`         | Optional helper plugin which dynamically generates Helm charts from kustomize output, preserving all customizations                                                                     |
...
[helm-v3alpha]: ./available/helm-v3-alpha.md
