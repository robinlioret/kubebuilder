...
import (
	...
	"sigs.k8s.io/kubebuilder/v4/pkg/plugins/optional/helm/v3alpha/scaffolds"
)
...
func (p *editSubcommand) Scaffold(fs machinery.Filesystem) error {
	...
	scaffolder := scaffolds.NewInstallerHelmScaffolder(p.config, p.force, p.manifestsFile, p.outputDir)
